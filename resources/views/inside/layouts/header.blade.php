...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark container">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <form id="logout-form" class="button-right" action="{{ route('logout') }}" method="POST">
        @csrf
        <button class="btn text--small button-logout" type="submit"><span style="color: #FFB801;">Salir</span> </button>
      </form>
    </ul>
  </div>
</nav>
