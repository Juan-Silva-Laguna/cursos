    ...
    <footer class="footer">
      <div class="footer__top">
        ...
        <div class="footer__top__payment-systems">
          <p class="payment-systems__title">Aceptamos los siguientes sistemas de pago</p>
          <div class="payment-systems__payments">
            <div class="payment-icon-container">
              <img src="{{Vite::asset('resources/images/visa.svg')}}" alt="Visa Card" />
            </div>
            <div class="payment-icon-container">
              <img src="{{Vite::asset('resources/images/mastercard.svg')}}" alt="Master Card" />
            </div>
            <div class="payment-icon-container">
              <img src="{{Vite::asset('resources/images/bitcoin.svg')}}" alt="Bitcoin" />
            </div>
          </div>
        </div>
      </div>
