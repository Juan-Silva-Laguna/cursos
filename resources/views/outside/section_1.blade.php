 <!-- Header Body -->
      <div class="header__body">
        <div class="grid grid--1x2 grid--centered grid-gap--small">
          ...
          <img src="{{Vite::asset('resources/images/btc-illustration.svg')}}" alt="Bitcoin illustration" class="btc-illustration" data-rellax-horizontal-speed="-2" data-rellax-vertical-scroll-axis="x"/>
        </div>
      </div>
      <img class="background-item-1" src="{{Vite::asset('resources/images/background-item-1.svg')}}" alt="" />
      <img class="background-item-2" src="{{Vite::asset('resources/images/background-item-2.svg')}}" alt="" />